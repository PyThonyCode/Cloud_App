  ...
  <div class = "container">
    ...
    <table class="table table-striped table-responsive">
      ...
      <tbody>
        ...
        $cadenaSQL = "SELECT a.nombre, a.apellido, a.direccion, a.telefijo, a.telefmovi, a.email, d.nombre AS distrito_nombre FROM agenda a
              INNER JOIN distrito d ON a.codigodis = d.codigodis";
